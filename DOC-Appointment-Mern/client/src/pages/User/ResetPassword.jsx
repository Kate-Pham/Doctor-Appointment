...
const ResetPassword = () => {
    ...
    const [newPassword, setNewPassworld] = useState('')
    ...
    return (
        <div className='d-flex flex-column align-items-center justify-content-center' style={{ minHeight: '80vh' }}>
            ...
            <div className="mb-3">
                ...
                <input type="text" value={oldPassword} onChange={e => setOldPassworld(e.target.value)} className='from-control' />
            </div>
            <div className="mb-3">
                <label htmlFor="" className='me-3'>Enter Your New Password</label>
                <input type="text" value={newPassword} onChange={e => setNewPassworld(e.target.value)} className='from-control' />
            </div>
